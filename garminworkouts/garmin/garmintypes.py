...
class GarminTypes(GarminApi):
    ...
    def get_strength_types(self) -> None:
        ...
        for exercises in MAP.keys():
            ...
            output_test_file_path: str = os.path.join(
                ".", "tests", "config", "generators", "strength", "test_" + exercises.lower() + ".py")
            write_test_functions_to_file(exercises, exercise_list, output_test_file_path)
